...
export default function AboutPage() {
  ...
  // ✅ Auto scroll navbar (horizontal + vertical)
  useEffect(() => {
  ...
  return (
    <div className="h-screen flex bg-gradient-to-b from-[#012818] via-[#04512c] to-[#f3fff7] overflow-hidde">
      ...
      bg-emerald-900 border-r border-white/10
      pt-24 px-3 gap-2
      ...
      <div className="md:hidden fixed top-20 left-1/2 -translate-x-1/2 z-[9999] w-full max-w-5xl px-4">
        <div
          ref={navRef}
          className="flex gap-3 overflow-x-auto no-scrollbar
    bg-emerald-900/80 backdrop-blur-xl border border-white/10
    rounded-full px-3 py-2 shadow-lg"
      ...
      pt-28 pb-16 px-4 flex justify-center no-scrollbar"
      >
        <div className="w-full max-w-7xl relative">
          ...
          <div className="relative w-full bg-white/95 backdrop-blur-xl rounded-[32px] border border-emerald-50 shadow-[0_24px_60px_rgba(0,0,0,0.25)] px-6 sm:px-10 py-10 space-y-10">
            ...
            <section id="overview" className="text-center space-y-4">
              ...
              <ul className="max-w-3xl mx-auto text-gray-600">
                <FeaturePill>
                  An intelligent platform that turns realtime soil and water
                  data into actionable farming insights.
                </FeaturePill>
              </ul>
            </section>
            ...
            >
              <>
                <p className="text-gray-700 text-justify">
                  ...
                  select the most suitable fertilizer based on soil nutrients
                  and crop type. The system uses machine learning to analyze key
                  parameters such as nitrogen (N), phosphorus (P), potassium
                  (K), temperature, humidity, moisture, and crop type to provide
                ...
                <p className="text-gray-700 text-justify">
                  ...
                  intuitive interface, and the backend processes this data using
                  a trained ML model to predict the best fertilizer along with a
                  confidence score.
                </p>
                <p className="text-gray-700 text-justify">
                  To enhance usability, the system can also display top multiple
                  fertilizer suggestions ranked by probability, allowing users
                  to make informed decisions. Additionally, the platform
                  includes educational content such as soil information and
                  benefits for farmers, making it both a predictive and
                  informative tool.
                </p>
              </>
            </Section>
            ...
            <section id="vision" className="text-center pt-6 border-t">
              ...
              <p className="text-gray-700 mt-2 max-w-xl mx-auto">
                ...
                with intelligent, data-driven insights that enhance
                productivity, promote sustainable practices, and improve
                livelihoods, while ensuring a smarter and more secure future for
                global food systems.
              </p>
            </section>
          </div>
